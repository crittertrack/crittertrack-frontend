        ...
        return (
            <div className="w-full flex justify-center">
                    ...
                    <div className="w-full px-1 sm:px-2 pb-0.5 sm:pb-1 flex-grow">
                        <div className="text-[11px] sm:text-xs md:text-sm font-semibold text-gray-800 dark:text-dark-text leading-tight text-center">
                            <AnimalNameWithFlag animal={animal} wrapperClassName="inline-flex max-w-full items-start justify-center gap-1 text-center" textClassName="break-words leading-tight text-center" flagClassName="inline-block h-4 w-6 shrink-0 align-middle rounded-sm border border-slate-200 dark:border-slate-700 overflow-hidden" />
                        </div>
                    </div>
                                    ...
                                    {!isBulkMode && (
                                        <div className="flex items-center border border-gray-300 dark:border-dark-text-muted rounded-lg overflow-hidden" onClick={(e) => e.stopPropagation()}>
                                            ...
                                            <button
                                                ...
                                                className="p-1 sm:p-1.5 hover:bg-gray-200 dark:hover:bg-dark-surface-hover transition disabled:opacity-30 disabled:cursor-not-allowed"
                                                title="Move Down"
                                            >
                                                <ChevronDown className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-gray-600 dark:text-dark-text-secondary" />
                                            </button>
                                        </div>
                                    )}
                                    <h3 className="text-sm sm:text-lg font-bold text-gray-700 dark:text-dark-text">
