                            ...
                            <div className="sm:col-span-2">
                                <div className="flex justify-between items-center mb-1">
                                    ...
                                    <div className="flex items-center gap-1 text-xs">
                                        <button type="button" onClick={() => setNewEnclosureForm(p => ({ ...p, lightTimeFormat: '12h' }))} className={`px-2 py-0.5 rounded ${enclosureFormData.lightTimeFormat === '12h' ? 'bg-blue-600 dark:bg-dark-info-blue text-white' : 'bg-gray-200 dark:bg-dark-card-bg dark:text-dark-text-secondary dark:border dark:border-dark-text-muted'}`}>12h</button>
                                        <button type="button" onClick={() => setNewEnclosureForm(p => ({ ...p, lightTimeFormat: '24h' }))} className={`px-2 py-0.5 rounded ${enclosureFormData.lightTimeFormat === '24h' ? 'bg-blue-600 dark:bg-dark-info-blue text-white' : 'bg-gray-200 dark:bg-dark-card-bg dark:text-dark-text-secondary dark:border dark:border-dark-text-muted'}`}>24h</button>
                                    </div>
                                </div>
                                <div className="flex gap-2">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <div className="bg-gray-100 dark:bg-dark-card-bg p-3 mt-2 rounded-lg border border-gray-200 dark:border-dark-text-muted space-y-2">
                                    ...
                                    }} className="w-full px-2 py-1.5 text-xs bg-blue-600 dark:bg-dark-info-blue text-white rounded font-medium hover:bg-blue-700 dark:hover:bg-dark-info-blue-hover">+ Add Task</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-between items-center gap-2 pt-2">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button onClick={handleSaveEnclosure} disabled={enclosureSaving || !enclosureFormData.name.trim()}
                                className="text-xs px-3 py-1.5 bg-blue-600 dark:bg-dark-info-blue hover:bg-blue-700 dark:hover:bg-dark-info-blue-hover text-white rounded-lg font-medium disabled:opacity-50 flex items-center gap-1.5">
