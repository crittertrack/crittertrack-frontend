...
const NOTIFICATION_TYPE_LABELS = {
  breeder_request: 'a breeder request', parent_request: 'a parent request',
  ...
  litter_assignment: 'a litter assignment', mating_reminder: 'a mating reminder',
...
const NotificationBar = ({ authToken, API_BASE_URL, userProfile, setShowNotifications, setShowMessages }) => {
  ...
  const bgColor = isUrgent ? 'bg-red-600 dark:bg-red-800' : 'bg-purple-600 dark:bg-dark-accent-purple/60';
