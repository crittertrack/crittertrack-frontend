...
// Lite mode's "Add Animal" flow — ported from crittertrack-lite's own QuickAddAnimalModal so
// the web Lite experience matches native exactly, instead of the full site's multi-page
// select-species -> add-animal form. Multi-step: quick-pick an already-owned species -> or
// browse by category -> species, then fill in the animal's details.
            ...
            <div className="bg-white dark:bg-dark-card-bg w-full max-w-sm rounded-2xl flex flex-col max-h-[85vh] overflow-hidden">
                ...
                <div className="overflow-y-auto px-4 py-3">
                    {(step !== 'details' && loadingOptions) ? (
                        <div className="flex justify-center py-10"><Loader2 className="animate-spin text-accent dark:text-dark-accent" size={24} /></div>
                    ) : step === 'quickPick' ? (
                        <div className="space-y-2">
                            ...
                            <button type="button" onClick={() => goto('category')} className="w-full mt-2 flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-xl border border-dashed border-gray-300 dark:border-dark-border text-sm font-semibold text-accent dark:text-dark-accent">
                        ...
                        <form onSubmit={handleSave} className="space-y-3">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <button
                                    ...
                                    className="text-xs font-semibold text-accent dark:text-dark-accent underline"
                                >
