...
const WelcomeGuideModal = ({ onClose }) => {
    ...
    const TutorialLink = ({ lessonId, children }) => (
        <button
            ...
            className="mt-1 inline-flex items-center gap-1 text-xs font-semibold text-accent dark:text-dark-accent hover:underline"
        >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
            <div className="bg-white dark:bg-dark-card-bg rounded-lg shadow-xl max-w-5xl w-full max-h-[95vh] sm:max-h-[90vh] flex flex-col">
                ...
                <div className="p-3 sm:p-5 space-y-3 sm:space-y-4 overflow-y-auto flex-1">
                    {/* Intro */}
                    <div className="bg-blue-50 dark:bg-dark-info-blue/20 border-l-4 border-blue-500 dark:border-dark-info-blue p-2.5 sm:p-3 rounded">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                        <div className="flex gap-2 sm:gap-3">
                            <div className="flex-shrink-0">
                                <div className="w-8 h-8 sm:w-9 sm:h-9 bg-purple-100 dark:bg-dark-accent-purple-bg rounded-full flex items-center justify-center">
                                    <User className="text-purple-600 dark:text-dark-accent-purple" size={16} />
                                </div>
                            </div>
                            <div className="flex-1">
                                <h3 className="font-semibold text-gray-800 dark:text-dark-text text-xs sm:text-sm mb-0.5 sm:mb-1">Breeder Name & Privacy</h3>
                        ...
                        <div className="flex gap-2 sm:gap-3">
                            <div className="flex-shrink-0">
                                <div className="w-8 h-8 sm:w-9 sm:h-9 bg-green-100 dark:bg-green-900/30 rounded-full flex items-center justify-center">
                                    <MapPin className="text-green-600 dark:text-green-400" size={16} />
                                </div>
                            </div>
                            <div className="flex-1">
                                <h3 className="font-semibold text-gray-800 dark:text-dark-text text-xs sm:text-sm mb-0.5 sm:mb-1">Country Location</h3>
                                <p className="text-xs text-gray-600 dark:text-dark-text-secondary leading-relaxed">
                        ...
                        <div className="flex gap-2 sm:gap-3">
                            <div className="flex-shrink-0">
                                <div className="w-8 h-8 sm:w-9 sm:h-9 bg-orange-100 dark:bg-orange-900/30 rounded-full flex items-center justify-center">
                                    <Users className="text-orange-600 dark:text-orange-400" size={16} />
                                </div>
                            </div>
                            <div className="flex-1">
                                <h3 className="font-semibold text-gray-800 dark:text-dark-text text-xs sm:text-sm mb-0.5 sm:mb-1">Community Activity</h3>
                                <p className="text-xs text-gray-600 dark:text-dark-text-secondary leading-relaxed">
                        ...
                        <div className="flex gap-2 sm:gap-3">
                            <div className="flex-shrink-0">
                                <div className="w-8 h-8 sm:w-9 sm:h-9 bg-blue-100 dark:bg-dark-info-blue/30 rounded-full flex items-center justify-center">
                                    <ShoppingBag className="text-blue-600 dark:text-dark-info-blue" size={16} />
                                </div>
                            </div>
                            <div className="flex-1">
                                <h3 className="font-semibold text-gray-800 dark:text-dark-text text-xs sm:text-sm mb-0.5 sm:mb-1">Breeders Registry</h3>
                                <p className="text-xs text-gray-600 dark:text-dark-text-secondary leading-relaxed">
                    ...
                    {/* Help Section */}
                    <div className="bg-gradient-to-r from-accent/10 to-primary/10 dark:from-dark-accent/20 dark:to-dark-primary/20 border border-accent/20 dark:border-dark-accent/30 rounded-lg p-2.5 sm:p-3">
                        <div className="flex gap-2 sm:gap-3 items-start">
                            <div className="flex-shrink-0">
                                <HelpCircle className="text-accent dark:text-dark-accent" size={18} />
                            </div>
                            <div className="flex-1">
                                <h3 className="font-semibold text-gray-800 dark:text-dark-text text-xs sm:text-sm mb-0.5 sm:mb-1">Need Help Getting Started?</h3>
                    ...
                    <div className="bg-gradient-to-r from-purple-50 to-purple-100 dark:from-dark-accent-purple-bg dark:to-dark-accent-purple-bg border border-purple-300 dark:border-dark-accent-purple/40 rounded-lg p-2.5 sm:p-3">
                        <div className="flex gap-2 sm:gap-3 items-start">
                            <div className="flex-shrink-0">
                                <MessageSquare className="text-purple-600 dark:text-dark-accent-purple" size={18} />
                            </div>
                            <div className="flex-1">
                                <h3 className="font-semibold text-gray-800 dark:text-dark-text text-xs sm:text-sm mb-0.5 sm:mb-1">🚀 Beta Testing & Your Feedback</h3>
                                <p className="text-xs text-gray-600 dark:text-dark-text-secondary">
                    ...
                    <div className="flex justify-end pt-2 sm:pt-1 sticky bottom-0 bg-white dark:bg-dark-card-bg pb-2 sm:pb-0 sm:static">
                        <button
                            onClick={handleClose}
                            disabled={isClosing}
                            className="w-full sm:w-auto px-4 sm:px-6 py-2.5 bg-accent dark:bg-dark-accent text-white rounded-lg hover:bg-accent/90 dark:hover:bg-dark-accent/90 transition font-medium text-sm disabled:opacity-50 flex items-center justify-center gap-2"
                        >
                            {isClosing ? (
                                <>
