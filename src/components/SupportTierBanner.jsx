    ...
    return (
        <div className="max-w-7xl mx-auto mb-3 bg-gradient-to-r from-blue-500 to-blue-700 text-white text-sm rounded-lg shadow-md px-4 py-3 flex items-center justify-between gap-3">
            <div className="flex-1">
                <span>
                    📱 Users have asked for an <strong>iOS version</strong> of CritterTrack! Building and maintaining an app on the Apple App Store means real ongoing costs: the development work itself (with a buffer for the unexpected), Apple's yearly developer fee to keep publishing and updating it afterward, and a higher server tier, since iOS would be a third platform running off the same server already handling growing user numbers. The website and installable PWA will always stay completely free to use. This is specifically about adding a third option: a dedicated iOS app. I already cover most of CritterTrack's costs out of pocket, but it needs to be sustainable long-term. So before I can even start that work, I need enough continuing monthly Ko-fi support, in any mix of tiers, to make it possible. We can do this together! Pick a tier and help get iOS launched:{' '}
