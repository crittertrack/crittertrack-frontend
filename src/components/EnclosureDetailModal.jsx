                    ...
                    {activeTab === 'dashboard' && (
                        <div className="space-y-3">
                            ...
                            <div className="bg-gray-50 dark:bg-dark-card-bg rounded-lg p-3 border border-gray-100 dark:border-dark-text-muted">
                                ...
                                <div className="w-full h-3 bg-gray-200 dark:bg-dark-text-muted/20 rounded-full overflow-hidden">
                                    <div
                                    ...
                                    {[...notes].reverse().map((note, idx) => (
                                        ...
                                        >
                                            <div className="flex justify-between items-start mb-1">
                                                <span className="text-[11px] font-medium text-gray-500 dark:text-dark-text-muted bg-gray-200 dark:bg-dark-text-muted/20 px-1.5 py-0.5 rounded">
