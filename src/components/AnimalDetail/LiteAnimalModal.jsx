                            ...
                            <div className="flex flex-col-reverse sm:flex-row sm:justify-between sm:items-start gap-2">
                                ...
                                <div className="flex items-center gap-2 flex-wrap justify-end sm:flex-nowrap">
                                    ...
                                    {onUpdateAnimal && <button onClick={() => {
                                        ...
                                        apiClient.put(`/animals/${animal.id_public}`, { isDisplay: newIsDisplay }).catch(() => onUpdateAnimal({ ...animal, isDisplay: !newIsDisplay }));
            ...
            <div className="space-y-2">
                {allRecords.map((litter) => {
                    ...
                    {activeTab === 'records' && (
                        <div className="space-y-3">
                            {[
                                { key: 'identification', label: 'Identification', icon: <Hash size={16} className="text-gray-400 dark:text-dark-text-muted" />, content: <IdentificationTabContent animal={animal} breedingLineDefs={breedingLineDefs} animalBreedingLines={animalBreedingLines} toggleAnimalBreedingLine={toggleAnimalBreedingLine} setAnimalBreedingLinesDirect={setAnimalBreedingLinesDirect} /> },
                                { key: 'appearance', label: 'Appearance', icon: <Palette size={16} className="text-gray-400 dark:text-dark-text-muted" />, content: <AppearanceTabContent animal={animal} onUpdateAnimal={onUpdateAnimal} authToken={authToken} API_BASE_URL={API_BASE_URL} /> },
