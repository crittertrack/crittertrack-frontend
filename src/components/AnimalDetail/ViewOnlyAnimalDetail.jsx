        ...
        <div className="fixed inset-0 bg-black/30 flex items-center justify-center p-2 sm:p-4 z-50 overflow-y-auto">
            <div className="bg-[#E1F2F5] rounded-xl shadow-2xl w-full max-w-6xl max-h-[95vh] sm:max-h-[90vh] my-2 sm:my-0 flex flex-col">
                ...
                <div className="bg-[#E1F2F5] border border-b-0 border-gray-300 rounded-t-lg">
                    <div className="flex flex-wrap gap-2 px-1 sm:px-4 py-2">
                        {[
                            ...
                            <button
                                ...
                                className={`w-[calc(20%-1rem)] px-1 py-2 text-[10px] sm:px-2 sm:text-xs font-medium rounded border-2 transition-colors ${
