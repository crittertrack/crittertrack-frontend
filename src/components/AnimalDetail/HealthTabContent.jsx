...
export const HealthTabContent = ({ animal, API_BASE_URL }) => {
    ...
    const vaccinations = parseJsonField(animal.vaccinations);
    const dewormingRecords = parseJsonField(animal.dewormingRecords);
    const parasiteControl = parseJsonField(animal.parasiteControl);
    const medicalProcedures = parseJsonField(animal.medicalProcedures);
    const labResults = parseJsonField(animal.labResults || animal.laboratoryResults);
    const medicalConditions = parseJsonField(animal.medicalConditions);
    const allergies = parseJsonField(animal.allergies);
    const medications = parseJsonField(animal.medications);
    const vetVisits = parseJsonField(animal.vetVisits);
