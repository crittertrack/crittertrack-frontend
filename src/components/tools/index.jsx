...
// NOTE: The following data files were not provided in the context.
// These imports assume their location is `crittertrack-frontend/src/data/`.
// The component will not render correctly without `tutorialLessonsNew.js` and `tutorialScreenshots.js`.
import { TUTORIAL_LESSONS } from '../../data/tutorialLessonsNew';
import { getStepScreenshot } from '../../data/tutorialScreenshots';

/**
 * A dedicated page for tutorials, replacing the old modal.
 */
const TutorialsPage = () => {
  ...
  // These will throw an error if TUTORIAL_LESSONS is not available.
    ...
    <div className="w-full h-full bg-white rounded-xl shadow-lg flex flex-col overflow-hidden">
      ...
      <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200 flex-shrink-0 bg-gradient-to-r from-primary/10 to-accent/10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-800">Tutorials</h2>
            <p className="text-gray-600 text-xs sm:text-sm mt-1">Browse guides to get started with CritterTrack.</p>
          </div>
        </div>
      </div>
