    ...
    return (
        <div className="p-4 sm:p-6 bg-white dark:bg-dark-card-bg rounded-xl shadow-lg">
            ...
            <div className="max-w-lg mx-auto mb-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <select
                        ...
                        className="w-full py-2.5 px-3 border border-gray-300 dark:border-dark-text-muted rounded-lg bg-white dark:bg-dark-bg text-gray-900 dark:text-dark-text focus:outline-none focus:ring-2 focus:ring-primary"
                    >
                ...
                <div>
                    ...
                    <div className="relative" ref={searchRef}>
                        <div className="flex items-center border border-gray-300 dark:border-dark-text-muted rounded-lg bg-white dark:bg-dark-bg">
            ...
            <div className="max-w-lg mx-auto mb-8">
                ...
                <div className="flex rounded-lg border border-gray-300 dark:border-dark-text-muted p-1 bg-gray-200 dark:bg-dark-bg">
                    <button 
                        onClick={() => setGraphMode('direct')}
                        className={`w-1/2 p-2 rounded-md text-sm font-semibold flex items-center justify-center gap-2 transition ${graphMode === 'direct' ? 'bg-white dark:bg-dark-card-bg shadow' : 'text-gray-600 dark:text-dark-text-secondary hover:bg-gray-300 dark:hover:bg-gray-700'}`}
                    >
                        Direct Lines
                    </button>
                    <button 
                        onClick={() => setGraphMode('full')}
                        className={`w-1/2 p-2 rounded-md text-sm font-semibold flex items-center justify-center gap-2 transition ${graphMode === 'full' ? 'bg-white dark:bg-dark-card-bg shadow' : 'text-gray-600 dark:text-dark-text-secondary hover:bg-gray-300 dark:hover:bg-gray-700'}`}
                    >
                        Full Graph
                    </button>
                </div>
