...
const RAT_COLOR_TRAIT_DEFS = [
  ...
  { id: 'rat-choc-agouti',   label: 'Chocolate Agouti (Sienna)', group: 'Brown Dilute', alternatives: [{ A: 'A/A', B: 'b/b' }] },
  ...
  { id: 'rat-beige',         label: 'Beige (Buff)',        group: 'Beige Dilute',  alternatives: [{ A: 'a/a', R: 'r/r' }] },
  { id: 'rat-topaz',         label: 'Topaz (Fawn)',        group: 'Beige Dilute', alternatives: [{ A: 'A/A', R: 'r/r' }] },
  ...
  { id: 'rat-marten',        label: 'Marten (Devil)',      group: 'C-locus & Color Modifier', alternatives: [{ C: 'cm/cm' }, { C: 'cm/c' }] },
  { id: 'rat-pointed-marten', label: 'Pointed Marten (Pointed Devil)', group: 'C-locus & Color Modifier', alternatives: [{ C: 'cm/ch' }] },
