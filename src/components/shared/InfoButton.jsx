    ...
    return (
        <div ref={containerRef} className={`relative inline-block ${className}`}>
            ...
            {open && (
                ...
                <div className={`absolute z-50 top-full mt-2 w-72 sm:w-80 max-w-[calc(100vw-2rem)] bg-white dark:bg-dark-card-bg border border-gray-200 dark:border-dark-border rounded-lg shadow-lg p-3 font-normal left-1/2 -translate-x-1/2 sm:translate-x-0 ${align === 'right' ? 'sm:right-0 sm:left-auto' : 'sm:left-0'}`}>
