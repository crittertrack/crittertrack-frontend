...
// just vanish unseen. Mounted once at the app root.
...
const SyncFailureBanner = () => {
    ...
    return (
        <div className="fixed left-3 right-3 bottom-3 z-[9999] space-y-2" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
            {failures.map((f) => (
