...
export const TUTORIAL_SCREENSHOTS = {
  ...
  'gs-fertility-information': {
    ...
    4: 'sire-information.png', // Step 4: Stud Information
  ...
  'gs-care-tab-feeding-daily-care': {
    1: 'care-tab.png', // Step 1: Animal Care Tab
  ...
  'gs-notes-milestones': {
    1: 'notes-and-milestones-tab.png', // Step 1: Notes Tab
    2: 'notes.png', // Step 2: Notes
    3: 'milestones.png', // Step 3: Milestones
  },
  ...
  'kf-viewing-animals': {
    ...
    4: 'pedigree-tab.png', // Step 4: Pedigree Chart Button
    5: 'Horizontal-pedigree-chart.png', // Step 5: Horizontal Pedigree Chart
    6: 'vertical-pedigree-chart.png', // Step 6: Vertical Pedigree Chart
    7: 'edit-button.png', // Step 7: Edit Button
    8: 'edit-view-overview.png', // Step 8: Edit View Overview
    9: 'delete-button.png', // Step 9: Delete Button
    10: 'close-edit-without-saving.png', // Step 10: Close Edit Without Saving
    11: 'add-sibling-button.png', // Step 11: Add Sibling Button
    12: 'sharing-animals.png', // Step 12: Sharing Animals
    13: 'archive-animal.png', // Step 13: Archive Animal
  },

  'kf-creating-litters': {
    1: 'move-to-litters.png', // Step 1: Move to Litters
    2: 'open-mating-first.png', // Step 2: Open Mating First
    3: 'choose-species-in-the-mating-modal.png', // Step 3: Choose Species for mating
    4: 'select-sire-and-dam.png', // Step 4: Select Sire & Dam
    5: 'add-mating-date-and-details.png', // Step 5: Add Mating Date & Details
    6: 'add-mating-notes.png', // Step 6: Complete Breeding Information
    7: 'save-the-planned-mating.png', // Step 7: Save the Planned Mating
    8: 'open-litter-next.png', // Step 8: Litter Management
    9: 'choose-species-in-the-litter-modal.png', // Step 9: Choose Species for Litter
    10: 'select-sire-and-dam-litter.png', // Step 10: Sire & Dam Selection
    11: 'add-litter-photos.png', // Step 11: Add Litter Photos
    12: 'set-pair-name.png', // Step 12: Set Pair Name & Parents
    13: 'complete-breeding-information.png', // Step 13: Complete Breeding Information
    14: 'record-dates-counts.png', // Step 14: Record Dates & counts
    15: 'create-new-offspring.png', // Step 15: Create New Offspring
    16: 'link-existing-animals.png', // Step 16: Link Existing Animals
    17: 'mating-card-details.png', // Step 17: Mating Card Details
    18: 'edit-and-convert-mating-to-litter.png', // Step 18: Edit & Convert Mating to Litter
    19: 'litter-actions.png', // Step 19: Litter Actions (edit, Add Offspring, etc)
    20: 'show-litter-publicly.png', // Step 20: Show Litter Publicly
  },

  'kf-profile-settings': {
    1: 'move-to-profile.png', // Step 1: move to profile
    2: 'profile-summary.png', // Step 2: Profile Summary
    3: 'edit-profile-button.png', // Step 3: Edit Profile Button
    4: 'profile-image.png', // Step 4: Profile Image
    5: 'personal-name-and-breeder-name.png', // Step 5: Personal Name & Breeder Name
    6: 'website-and-country.png', // Step 6: Website & Country
