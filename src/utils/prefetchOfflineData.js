...
// tab/screen yet while online — instead of only caching lazily whenever a page happens to be
// visited. apiClient's response interceptor already caches every successful GET body
// automatically (see apiClient.js), so this module just needs to trigger the requests; results
// are only inspected here to find photo URLs to warm into the image cache (offlineImageCache.js).
